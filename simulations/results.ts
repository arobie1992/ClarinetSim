...
class Parser {
    ...
    private readonly total = "Grand Total";
    ...
    private readonly body = String.raw`{${this.nl}    ${this.coop}${this.nl}    ${this.mal}${this.nl}    ${this.neighbors}${this.nl}    ${this.coop_ind}${this.nl}    ${this.mal_ind}${this.nl}    ${this.neighbors_ind}${this.nl}}`;
    private readonly node_info = String.raw`(?<${this.node_info_grp}>${this.node}|${this.total})`;
    ...
    parse(): ParseResult {
        ...
        for(const match of matches) {
            ...
            parsed.push(new NodeReputation(type, coop, mal, withNeighbors, coopIndividual, malIndividual, neighborsIndividual));
        }
